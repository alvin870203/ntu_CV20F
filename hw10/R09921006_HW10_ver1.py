...
if __name__ == '__main__':
	...
	LaplacianOfGaussianImage = zeroCrossingDetector(LaplacianOfGaussianArray, 3, 3)
	# Save min-Variance Laplacian image.
	...
	DifferenceOfGaussianImage = zeroCrossingDetector(DifferenceOfGaussianArray, 3, 3)
